...
const FeaturedProperties = () => {
  ...
  const PropertyCard = ({ property }) => (
    <div className="w-full">
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group lg:w-[96%]  w-[90%] mx-auto lg:mx-3">
        {/* Property Image */}
    ...
    <section className="py-16 bg-white" id='featured-property'>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <button className="swiper-button-prev-custom absolute lg:left-[-29px] left-0 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-[#AC9020] rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group">
          ...
          <button className="swiper-button-next-custom absolute lg:right-[-29px] right-0 top-1/2 -translate-y-1/2 z-10 bg-white hover:bg-[#AC9020] rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group">
            <svg className="w-6 h-6 text-[#AC9020] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
